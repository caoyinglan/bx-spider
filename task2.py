...
class baixing(object):
    ...
    def get_contents(self):
        ...
        proxies={'http': 'http://222.37.130.229:46603',
                'https': 'http://222.37.130.229:46603'}
        response = requests.get(self._url, proxies=proxies, headers=self._headers, verify=False)
        response1 = requests.get(self._url, proxies=proxies, headers=self._headers, verify=False)
        response2 = requests.get(self._url, proxies=proxies, headers=self._headers, verify=False)
        response3 = requests.get(self._url, proxies=proxies, headers=self._headers, verify=False)
        response4 = requests.get(self._url, proxies=proxies, headers=self._headers, verify=False)
        response5 = requests.get(self._url, proxies=proxies, headers=self._headers, verify=False)
        response6 = requests.get(self._url, proxies=proxies, headers=self._headers, verify=False)
        response7 = requests.get(self._url, proxies=proxies, headers=self._headers, verify=False)
